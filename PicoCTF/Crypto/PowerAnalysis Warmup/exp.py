...
def connect_server(pt):
    # r = process(['python', 'encrypt.py'])
    r = remote("saturn.picoctf.net", 61008)
    r.recvuntil(b"Please provide 16 bytes of plaintext encoded as hex:")
    r.sendline(binascii.hexlify(pt))
    r.recvuntil(b"leakage result: ")
