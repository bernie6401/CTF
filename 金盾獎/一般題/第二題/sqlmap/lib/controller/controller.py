...
# Edited by Youzong date 2023-03-29
'''
This function is used to select the payload for injection.
The payload which did not pass in the previous round will select first.
I have only modified _selectInjection().
'''
