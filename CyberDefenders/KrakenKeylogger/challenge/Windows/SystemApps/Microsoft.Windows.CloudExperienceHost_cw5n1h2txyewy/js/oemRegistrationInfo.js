        ...
        class OEMRegistrationHelper {
            ...
            saveOEMRegistrationInfo(elements) {
                return new WinJS.Promise(function (completeDispatch, errorDispatch /*, progressDispatch */) {
                    ...
                    this._bridge.invoke("CloudExperienceHost.OEMRegistrationInfo.saveOEMRegisrationInfo", JSON.stringify(registrationInfo)).then(function () {
                        completeDispatch();
                    }.bind(this), errorDispatch);
                }.bind(this));
            }
            ...
            _getOEMRegistrationInfo() {
                return new WinJS.Promise(function (completeDispatch, errorDispatch /*, progressDispatch */) {
                    this._bridge.invoke("CloudExperienceHost.OEMRegistrationInfo.retrieveOEMRegisrationInfo").then(function (registrationInfo) {
