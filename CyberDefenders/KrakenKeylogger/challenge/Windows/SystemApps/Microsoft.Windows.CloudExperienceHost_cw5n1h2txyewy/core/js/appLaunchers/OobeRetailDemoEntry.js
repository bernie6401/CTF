    ...
    class OOBERetailDemoEntry {
        launchAsync(currentNode) {
            return new WinJS.Promise(function (completeDispatch /*, errorDispatch, progressDispatch */) {
                let retailDemoEnabled = CloudExperienceHost.Storage.SharableData.getValue("retailDemoEnabled");
                if (retailDemoEnabled && CloudExperienceHost.FeatureStaging.isOobeFeatureEnabled("InclusiveRetailDemoOobe")) {
