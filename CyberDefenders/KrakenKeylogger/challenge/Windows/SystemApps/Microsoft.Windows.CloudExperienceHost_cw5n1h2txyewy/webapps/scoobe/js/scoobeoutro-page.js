...
(() => {
    WinJS.UI.Pages.define("/webapps/scoobe/view/scoobeoutro-main.html", {
        ...
        ready: (element, options) => {
            require(['lib/knockout', 'jsCommon/scoobe-knockout-helpers', 'legacy/bridge', 'legacy/events', 'scoobeoutro-vm', 'lib/knockout-winjs'], (ko, KoHelpers, bridge, constants, ScoobeOutroViewModel) => {
                ...
                let vm = new ScoobeOutroViewModel.ScoobeOutroViewModel(this.resourceStrings);
                ko.applyBindings(vm);
