    ...
    (function (UnifiedEnroll) {
        ...
        WinJS.UI.Pages.define("/webapps/unifiedEnrollment/views/unifiedEnrollment.html", {
            init: function (element, options) {
                ...
                return WinJS.Promise.join({ languagePromise: languagePromise, dirPromise: dirPromise, stringPromise: stringPromise, cssPromise: cssPromise, queryStringPromise: queryStringPromise, dataSetupPromise: dataSetupPromise });
            },
