(() => {
    WinJS.UI.Pages.define("/webapps/inclusiveOobe/view/ooberegion-main.html", {
        ...
        ready: (element, options) => {
            require(['lib/knockout', 'jsCommon/knockout-helpers', 'jsCommon/oobe-gesture-manager', 'legacy/bridge', 'legacy/core', 'legacy/events', 'ooberegion-vm', 'lib/knockout-winjs'], (ko, KoHelpers, gestureManager, bridge, core, constants, RegionViewModel) => {
