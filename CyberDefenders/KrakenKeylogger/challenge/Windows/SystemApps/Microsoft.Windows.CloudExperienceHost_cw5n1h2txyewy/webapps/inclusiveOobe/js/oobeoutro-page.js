...
(() => {
    WinJS.UI.Pages.define("/webapps/inclusiveOobe/view/oobeoutro-main.html", {
        ...
        ready: (element, options) => {
            require(['lib/knockout', 'jsCommon/knockout-helpers', 'legacy/bridge', 'legacy/events', 'oobeoutro-vm', 'lib/knockout-winjs'], (ko, KoHelpers, bridge, constants, OutroViewModel) => {
