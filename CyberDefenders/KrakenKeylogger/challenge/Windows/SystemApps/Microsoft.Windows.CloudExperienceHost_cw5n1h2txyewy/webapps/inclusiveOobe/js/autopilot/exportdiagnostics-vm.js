...
define([
    ...
    class ExportDiagnosticsViewModel {
        ...
        exportLogsButtonClick() {
            this.commercialDiagnosticsUtilities.logInfoEvent("CommercialOOBE_ExportDiagnostics_LogsExport_Started", "Started");
            ...
            return this.commercialDiagnosticsUtilities.getExportLogsFolderPathAsync().then((folderPath) => {
                this.commercialDiagnosticsUtilities.logInfoEvent(
                    "CommercialOOBE_ExportDiagnostics_LogsExport_OutputPath",
                    this.commercialDiagnosticsUtilities.formatMessage("Returned folder path: {0}", folderPath));
                return bridge.invoke("CloudExperienceHost.Storage.SharableData.getValue", this.DIAGNOSTICS_LOGS_EXPORT_AREA_NAME).then(
                    (logsAreaValue) => {
                        ...
                        this.commercialDiagnosticsUtilities.logInfoEvent(
                            "CommercialOOBE_ExportDiagnostics_LogsExport_OutputPath",
                            this.commercialDiagnosticsUtilities.formatMessage("Output logfile path: {0}", outputLogFilePath));
                        return this.sessionUtilities.enrollmentApis.collectLogsEx(logsAreaValue, outputLogFilePath).then(() => {
                            ...
                            this.pageTitle(this.resourceStrings["ExportDiagnosticsPageLogsExportSuccessTitle"]);
        ...
        displayError(buttonVisibility, code, description, subheaderOverride, filePath) {
            ...
            // Constants
            const E_AUTOPILOT_SURFACE_HUB_LOG_EXPORT_NO_DRIVE = -2130468841;
            const E_AUTOPILOT_SURFACE_HUB_LOG_EXPORT_TOO_MANY_DRIVES = -2130468840;
            const E_AUTOPILOT_SURFACE_HUB_LOG_EXPORT_FAILED = -2130468839;
            const ERROR_FILE_EXISTS = -2147024816;
            const ERROR_TIMEOUT = -2147023436;

            let errorDescription = null;
            switch (code) {
                case E_AUTOPILOT_SURFACE_HUB_LOG_EXPORT_NO_DRIVE:
                    errorDescription = this.resourceStrings["E_AUTOPILOT_SURFACE_HUB_LOG_EXPORT_NO_DRIVE"];
                    break;
                case E_AUTOPILOT_SURFACE_HUB_LOG_EXPORT_TOO_MANY_DRIVES:                    
                    errorDescription = this.resourceStrings["E_AUTOPILOT_SURFACE_HUB_LOG_EXPORT_TOO_MANY_DRIVES"];
                    break;
                case E_AUTOPILOT_SURFACE_HUB_LOG_EXPORT_FAILED:
                    errorDescription = this.resourceStrings["E_AUTOPILOT_SURFACE_HUB_LOG_EXPORT_FAILED"];
                    break;
                case ERROR_FILE_EXISTS:
                    errorDescription = this.commercialDiagnosticsUtilities.formatMessage(
                        this.resourceStrings["ERROR_FILE_EXISTS"],
                        filePath);
                    break;
                case ERROR_TIMEOUT:
                    errorDescription = this.commercialDiagnosticsUtilities.formatMessage(
