...
(function () {
    ...
    require(['lib/knockout', 'jsCommon/knockout-helpers', 'legacy/bridge', 'legacy/events', 'legacy/core', 'legacy/uiHelpers'], (ko, KoHelpers, bridge, constants, core, uiHelpers) => {
        "use strict";
        ...
        const feature_HeyCortanaOOBEWoV = "HeyCortanaOOBEWoV";
        ...
        pages.forEach((page) => {
            ...
            function talkToCortanaCheckboxVisible() {
                return isOOBEFeatureEnabled(feature_HeyCortanaOOBEWoV) ? 
                ((cortanaManager.hasMicrophone) && (!cortanaManager.isMobileDeviceWithBatteries || cortanaManager.isBatteryCertified)) :
                ((cortanaManager.hasMicrophone && !cortanaManager.isMobileDeviceWithBatteries));
            }
        
            function talkToCortanaCheckboxText(cortanaResources) {
                if(isOOBEFeatureEnabled(feature_HeyCortanaOOBEWoV) && cortanaManager.hasMicrophone) {
