(() => {
    WinJS.UI.Pages.define("/webapps/inclusiveOobe/view/oobesettings-multipage-main.html", {
        ...
        ready: (element, options) => {
            require(['lib/knockout', 'jsCommon/knockout-helpers', 'legacy/bridge', 'legacy/events', 'oobesettings-multipage-vm', 'oobesettings-data', 'lib/knockout-winjs'], (ko, KoHelpers, bridge, constants, SettingsMultiPageViewModel) => {
