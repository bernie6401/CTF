...
(() => {
    WinJS.UI.Pages.define("/webapps/inclusiveOobe/view/oobeprovisioningprogress-main.html", {
        ...
        ready: (element, options) => {
            require(['lib/knockout', 'jsCommon/knockout-helpers', 'legacy/bridge', 'legacy/events', 'oobeprovisioningprogress-vm', 'lib/knockout-winjs'], (ko, KoHelpers, bridge, constants, provisioningProgressViewModel) => {
