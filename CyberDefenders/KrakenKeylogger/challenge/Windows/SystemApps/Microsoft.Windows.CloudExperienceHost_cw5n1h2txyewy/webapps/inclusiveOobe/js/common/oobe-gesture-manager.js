...
//
define(["lib/knockout", 'jsCommon/knockout-helpers', "legacy/bridge", "legacy/core", "legacy/appObjectFactory"], (ko, KoHelpers, bridge, core, appObjectFactory) => {
    ...
    class GestureManager {
        ...
        reevaluateRetailDemoEntryAllowed() {
            ...
            try {
                isRetailDemoSuppported = appObjectFactory.getObjectFromString("CloudExperienceHostBroker.RetailDemo.ConfigureRetailDemo").isRetailDemoSupported;
            }
            catch (err) {
                // RetailDemo is unavailable
            }
        ...
        retailDemoGestureDetected() {
            bridge.invoke("CloudExperienceHost.FeatureStaging.isOobeFeatureEnabled", "InclusiveRetailDemoOobe").done((result) => {
                if (result) {
                ...
                bridge.invoke("CloudExperienceHost.Telemetry.logEvent", "GetIsOobeFeatureEnabled", core.GetJsonFromError(error));
            });
        }
