...
(() => {
    WinJS.UI.Pages.define("/webapps/inclusiveOobe/view/oobeprovisioningstatus-main.html", {
        ...
        ready: (element, options) => {
            require(['lib/knockout', 'jsCommon/knockout-helpers', 'legacy/bridge', 'legacy/events', 'oobeprovisioningstatus-vm', 'lib/knockout-winjs'], (ko, KoHelpers, bridge, constants, ProvisioningStatusViewModel) => {
