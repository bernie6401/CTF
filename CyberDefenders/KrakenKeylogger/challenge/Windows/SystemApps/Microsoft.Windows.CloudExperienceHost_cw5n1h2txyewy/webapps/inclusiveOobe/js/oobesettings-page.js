(() => {
    var pages = [
        ...
        {
            uri: "/webapps/inclusiveOobe/view/oobesettings-fourtogglepage-main.html",
            viewmodel: 'oobesettings-fourtogglepage-vm'
        }
    ];
    ...
    pages.forEach((page) => {
        WinJS.UI.Pages.define(page.uri, {
            ...
            ready: (element, options) => {
                require(['lib/knockout', 'jsCommon/knockout-helpers', 'legacy/bridge', 'legacy/events', page.viewmodel, 'oobesettings-data', 'lib/knockout-winjs'], (ko, KoHelpers, bridge, constants, SettingsViewModel) => {
