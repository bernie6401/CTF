...
(() => {
    WinJS.UI.Pages.define("/webapps/inclusiveOobe/view/oobeerror-main.html", {
        ...
        ready: (element, options) => {
            require(['lib/knockout', 'jsCommon/knockout-helpers', 'legacy/bridge', 'legacy/events', 'oobeerror-vm', 'lib/knockout-winjs'], (ko, KoHelpers, bridge, constants, ErrorViewModel) => {
