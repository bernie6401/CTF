...
(() => {
    WinJS.UI.Pages.define("/webapps/inclusiveoobe/view/oobeautopilotactivation-main.html", {
        ...
        ready: (element, options) => {
            require(['lib/knockout', 'jsCommon/knockout-helpers', 'legacy/bridge', 'legacy/events', 'oobeautopilotactivation-vm', 'lib/knockout-winjs'], (ko, KoHelpers, bridge, constants, AutopilotActivationViewModel) => {
                ...
                let vm = new AutopilotActivationViewModel(this.resourceStrings);
                ko.applyBindings(vm);
