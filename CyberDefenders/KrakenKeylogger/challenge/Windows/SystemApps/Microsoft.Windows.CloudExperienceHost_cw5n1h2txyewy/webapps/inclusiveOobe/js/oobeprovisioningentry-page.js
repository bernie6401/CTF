...
(() => {
    WinJS.UI.Pages.define("/webapps/inclusiveOobe/view/oobeprovisioningentry-main.html", {
        ...
        ready: (element, options) => {
            require(['lib/knockout', 'jsCommon/knockout-helpers', 'legacy/bridge', 'legacy/events', 'oobeprovisioningentry-vm', 'lib/knockout-winjs'], (ko, KoHelpers, bridge, constants, ProvisioningEntryViewModel) => {
