(() => {
    WinJS.UI.Pages.define("/webapps/inclusiveOobe/view/personalDataExport-main.html", {
        ...
        ready: (element, options) => {
            require(['lib/knockout', 'jsCommon/knockout-helpers', 'legacy/bridge', 'legacy/events', 'personalDataExport-vm', 'oobesettings-data', 'lib/knockout-winjs'], (ko, KoHelpers, bridge, constants, PersonalDataExportViewModel) => {
