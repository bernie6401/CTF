    ...
    pages.forEach((page) => {
        WinJS.UI.Pages.define(page.uri, {
            ...
            ready: (element, options) => {
                require(['lib/knockout', 'jsCommon/knockout-helpers', 'legacy/bridge', 'legacy/events', page.viewmodel, 'lib/knockout-winjs'], (ko, KoHelpers, bridge, constants, UpdateSettingsViewModel) => {
                    ...
                    let vm = new UpdateSettingsViewModel(this.resourceStrings, this.isInternetAvailable, this.targetPersonality);
                    ko.applyBindings(vm);
