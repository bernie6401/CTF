...
(() => {
    WinJS.UI.Pages.define("/webapps/inclusiveoobe/view/oobeautopilotreboot-main.html", {
        ...
        ready: (element, options) => {
            require(['lib/knockout', 'jsCommon/knockout-helpers', 'legacy/bridge', 'legacy/events', 'oobeautopilotreboot-vm', 'lib/knockout-winjs'], (ko, KoHelpers, bridge, constants, AutopilotRebootViewModel) => {
                // Setup knockout customizations
                koHelpers = new KoHelpers();
                koHelpers.registerCustomComponents();

                // Apply bindings and show the page
                let vm = new AutopilotRebootViewModel(this.resourceStrings);
                ko.applyBindings(vm);
